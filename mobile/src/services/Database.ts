...
const seedComplaints: SeedComplaint[] = [
  ...
  },
  {
    ...
    resolutionNote: 'Se coordinó reabastecimiento.',
  ...
  },
  {
    ...
    detail: 'El cliente no recibió comprobante.',
    source: 'cliente',
    reporterName: 'Jorge R.',
    reporterRole: 'cliente',
    status: 'resolved',
    resolvedAt: '2025-12-08T11:30:00.000Z',
    resolutionNote: 'Se emitió factura posterior.',
    createdAt: '2025-12-08T09:05:00.000Z',
  },
];

const seedVehicles = [
  { plate: 'PBA-1024', model: 'Toyota Hilux 2019', capacityLiters: 120, fuelType: 'Diésel', ownerName: 'Andrea G.' },
  { plate: 'ABC-5531', model: 'Chevrolet D-Max 2021', capacityLiters: 95, fuelType: 'Diésel', ownerName: 'Carlos D.' },
  { plate: 'GQX-2287', model: 'Kia Sportage 2018', capacityLiters: 60, fuelType: 'Extra', ownerName: 'Maria V.' },
  { plate: 'PCE-7740', model: 'Hyundai H1 2020', capacityLiters: 75, fuelType: 'Diésel', ownerName: 'Luis P.' },
];
